    ...
    def separate(self, neighbors):
        ...
        for neighbor in neighbors:
            ...
            if dist < self.separation:
                # is het wel logisch dat een heel kleine afstand tussen mij 
                # en mijn buur zorgt voor een heel kleine sep_vector? 
                # Moet dit niet juist heel groot zijn?
...
class FlockModel(Model):
    ...
    def __init__(self, N, width, height):
        ...
        for i in range(self.num_agents):
            a = Boid(i, self, (self.random.uniform(0, width), self.random.uniform(0, height)))
            self.schedule.add(a)
